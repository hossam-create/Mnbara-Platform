...
export default function ProfilePage() {
  ...
  const MENU_ITEMS = [
    { icon: <Settings size={18} />, label: "My Dashboard", desc: "Overview of your store, listings & orders", href: "/dashboard" },
    { icon: <Package size={18} />, label: "My Listings", desc: "Manage your active listings", href: "/dashboard" },
