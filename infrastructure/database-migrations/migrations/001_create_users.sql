...
-- Description: Creates the users table and related authentication tables
-- Created: 2024-01-01
...
CREATE TABLE IF NOT EXISTS users (
    ...
    preferences JSONB DEFAULT '{"notifications": {"email": true, "push": true, "sms": false}, "privacy": {"show_profile": true, "show_orders": false}, "theme": "light", "currency": "USD"}'::jsonb,
    statistics JSONB DEFAULT '{"total_orders": 0, "completed_orders": 0, "cancelled_orders": 0, "total_spent": 0, "total_earned": 0, "average_rating": 0, "review_count": 0}'::jsonb,
