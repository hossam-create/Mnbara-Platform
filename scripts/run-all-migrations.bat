...
set DATABASE_URL=postgresql://mnbarh:mnbarh_dev_password@localhost:5432/auth_db?schema=public
...
set DATABASE_URL=postgresql://mnbarh:mnbarh123@localhost:5432/user_db?schema=public
call npx prisma migrate deploy
if %errorlevel% neq 0 (
...
set DATABASE_URL=postgresql://mnbarh:mnbarh123@localhost:5432/payment_db?schema=public
call npx prisma migrate deploy
if %errorlevel% neq 0 (
...
set DATABASE_URL=postgresql://mnbarh:mnbarh123@localhost:5432/product_db?schema=public
call npx prisma migrate deploy
if %errorlevel% neq 0 (
...
set DATABASE_URL=postgresql://mnbarh:mnbarh123@localhost:5432/wallet_db?schema=public
call npx prisma migrate deploy
if %errorlevel% neq 0 (
...
set DATABASE_URL=postgresql://mnbarh:mnbarh123@localhost:5432/orders_db?schema=public
call npx prisma migrate deploy
if %errorlevel% neq 0 (
...
set DATABASE_URL=postgresql://mnbarh:mnbarh123@localhost:5432/escrow_db?schema=public
call npx prisma migrate deploy
if %errorlevel% neq 0 (
...
set DATABASE_URL=postgresql://mnbarh:mnbarh123@localhost:5432/trips_db?schema=public
call npx prisma migrate deploy
if %errorlevel% neq 0 (
...
set DATABASE_URL=postgresql://mnbarh:mnbarh123@localhost:5432/matching_db?schema=public
call npx prisma migrate deploy
if %errorlevel% neq 0 (
...
cd backend\services\notification-service
set DATABASE_URL=postgresql://mnbarh:mnbarh123@localhost:5432/notification_db?schema=public
call npx prisma migrate deploy
if %errorlevel% neq 0 (
...
if exist backend\services\subscription-service (
    ...
    set DATABASE_URL=postgresql://mnbarh:mnbarh123@localhost:5432/subscription_db?schema=public
    call npx prisma migrate deploy
    cd ..\..\..
)
