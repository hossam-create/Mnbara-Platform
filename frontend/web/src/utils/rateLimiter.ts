/**
 * Rate Limiter Utility for MNBARA Web Application
...
const DEFAULT_CONFIG: Required<Omit<RateLimiterConfig, 'onRateLimited' | 'onRateLimitCleared'>> = {
...
class RateLimiter {
  ...
  private config: Required<Omit<RateLimiterConfig, 'onRateLimited' | 'onRateLimitCleared'>>;
  ...
  /**
   * Handle a successful request (reset consecutive errors)
   */
  handleSuccess(): void {
