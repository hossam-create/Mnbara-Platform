          ...
          <div className="max-w-[1400px] mx-auto px-4 h-full">
            <div className="flex items-center justify-between h-full text-xs text-white font-normal">
              ...
              <div className="flex items-center gap-4">
                ...
                {/* Plugins removed from MVP nav - keep route for "Coming soon" */}
                <button 
              ...
              <div className="flex items-center gap-4">
                ...
                <Link to="/user/saved-items" className="flex items-center hover:text-brand-yellow font-normal">
                  {t('header.watchlist')}
                  <ChevronDownIcon />
                </Link>
                <Link to="/user/dashboard" className="flex items-center hover:text-brand-yellow font-bold">
                  {t('header.myMnbarh')}
                  <ChevronDownIcon />
                </Link>
