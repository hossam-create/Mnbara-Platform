...
exports.LiveAuctionManager = void 0;
const events_1 = require("events");
class LiveAuctionManager extends events_1.EventEmitter {
     ...
     */
    async getStreamAuctions(streamId) {
        try {
            const auctions = await this.prisma.liveAuction.findMany({
                where: {
                    streamId,
...
exports.LiveAuctionManager = LiveAuctionManager;
//# sourceMappingURL=LiveAuctionManager.js.map