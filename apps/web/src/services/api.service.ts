...
// Create API client instance using shared package
const apiClientInstance = new ApiClient({
  baseURL: API_BASE_URL,
  timeout: 30000,
});

// Get the underlying axios instance for interceptor setup
...
// Setup response interceptor with custom error handling
