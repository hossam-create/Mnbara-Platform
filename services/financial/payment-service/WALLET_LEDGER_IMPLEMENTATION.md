...
**File**: `services/financial/payment-service/prisma/migrations/20251211_add_wallet_ledger_table/migration.sql`
...
**File**: `services/financial/payment-service/src/services/wallet-ledger.service.ts`
...
**Files**:
- `services/financial/payment-service/WALLET_LEDGER_GUIDE.md` - Comprehensive usage guide
- `services/financial/payment-service/WALLET_LEDGER_IMPLEMENTATION.md` - This file
